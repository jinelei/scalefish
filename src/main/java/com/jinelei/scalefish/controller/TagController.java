...
public class TagController {
    ...
    @PutMapping("/{id}")
    public GenericResult<com.jinelei.scalefish.entity.Tag> update(
            @Parameter(description = "标签 ID") @PathVariable Long id,
            @Valid @RequestBody TagRequest req) {
        log.info("PUT /api/tags/{} - name={}", id, req.name());
        return GenericResult.success(tagService.update(id, req));
    }
